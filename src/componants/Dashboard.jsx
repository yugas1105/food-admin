    ...
    <>
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Typography variant='h4'>$64,890</Typography>
        </Box>
        ...
        <Box sx={{
          ...boxStyle,
          backgroundImage: 'radial-gradient( circle farthest-corner at 10% 20%,  rgba(235,183,241,1) 17.3%, rgba(228,145,235,1) 90% )'
          }}>
        ...
        <Box sx={{
          ...boxStyle,
          backgroundImage: 'linear-gradient( 359.5deg,  rgba(115,122,205,1) 8.8%, rgba(186,191,248,1) 77.4% )'     
        }}>
